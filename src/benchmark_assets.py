...
def build_answer_seed_draft(*, retrieval_seed_rows: list[dict[str, Any]], chunks: list[dict[str, Any]], manifest: list[dict[str, Any]]) -> list[dict[str, Any]]:
    ...
    for row in _select_answer_seed_rows(retrieval_seed_rows):
        intent = row["intent"]
        ...
        draft_rows.append(
            {
                ...
                "review_notes": "draft_auto_generated_from_retrieval_seed",
            }
        )
    return draft_rows
